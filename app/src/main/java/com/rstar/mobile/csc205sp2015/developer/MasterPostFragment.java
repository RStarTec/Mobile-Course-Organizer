		...
		protected Boolean doInBackground(Object... args) {
			...
			try {
                if (type.equals(type_signup)) {
                    ...
                    String email = null;
                    postData = MasterApi.class.getSimpleName() + ":\n";
                    api = new MasterApi(appContext, userId, password, newPassword, email, MasterApi.request_mastersignin);
                }
                    ...
                    String email = null;
                    postData = MasterApi.class.getSimpleName() + ":\n";
                    api = new MasterApi(appContext, userId, password, newPassword, email, MasterApi.request_masterunset);
                }
                else if (type.equals(type_passwd)) {
                    // Put some valid testers here
                    String userId = "nova1";
                    String password = null;
                    String newPassword = "nova2";
                    String email = null;

                    postData = MasterApi.class.getSimpleName() + ":\n";
                    api = new MasterApi(appContext, userId, password, newPassword, email, MasterApi.request_masterpasswd);
                }
                    ...
                    postData = MasterApi.class.getSimpleName() + ":\n";
                    api = new MasterApi(appContext, userId, moduleNumber, MasterApi.request_masterscore);
                }
                    ...
                    postData = MasterApi.class.getSimpleName() + ":\n";
                    api = new MasterApi(appContext, userId, moduleNumber, MasterApi.request_masterfeedback);
                }
