...
public class HelpFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (AppSettings.testerEnabled) {
            // if tester enabled, then add help to icons that are offered to testers only
            mHelpList = TesterMenu.addList(mHelpList);
        }
    ...
    private static class HelpListAdapter extends ArrayAdapter<Icon> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView==null) {
                convertView = hostFragment.getActivity().getLayoutInflater().inflate(R.layout.list_item_help, parent, false);
            }
