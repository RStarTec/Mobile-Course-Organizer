...
package com.rstar.mobile.csc205sp2015.tools.memory;
...
import com.rstar.mobile.csc205sp2015.tools.util.PixelUtil;
import com.rstar.mobile.csc205sp2015.tools.util.Thumb;

/**
 * Created by AHui on 2/23/15.
 */
public class Mem2LCharts extends ImageView {
    ...
    private void init(Context context, Tiers tiers) {
        ...
        upThumb = new Thumb(context, R.drawable.seek_pointer_up, R.drawable.seek_pointer_up);
        leftThumb = new Thumb(context, R.drawable.seek_pointer_left, R.drawable.seek_pointer_left);
